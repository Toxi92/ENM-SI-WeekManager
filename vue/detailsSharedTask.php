<?php
include_once("../controlleur/controlleur_details_shared_task.php");
    ...
    <main>
        <div class="DivDetailsTask">
            ...
            ?>
                ...
                <form action="../controlleur/controlleur_details_shared_task.php" method="post" style="margin-bottom:20px;">
                ...
                <form action="../controlleur/controlleur_details_shared_task.php" method="post" class="FormCouleurTache">
                    <input type="hidden" name="task_id" value="<?php echo $task['id']; ?>">
