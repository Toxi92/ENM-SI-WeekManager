<?php
include_once("../controlleur/controlleur_ajout_shared_task.php"); 
...
<body>
    <main>
        <div class="DivAjoutTacheForm">
            ...
            <form action="../controlleur/controlleur_ajout_shared_task.php?edt_owner_email=<?php echo urlencode($_GET['edt_owner_email'])  ?>&edt_id=<?php echo urlencode($_GET['edt_id'])  ?>"" method="post" class="FormAjoutTache">
